...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps(ctx) {
    const props = _objectSpread({}, (await next_document__WEBPACK_IMPORTED_MODULE_1___default.a.getInitialProps(ctx)));
  ...
  render() {
    return __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Html"], null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Head"], null, __jsx("meta", {
      ...
      rel: "stylesheet",
      href: "/bulma/extensions/tooltip/bulma-tooltip.min.css"
    }), __jsx("script", {
      defer: true,
