...
module.exports = __webpack_require__("ELfE");
...
const list = async (req, res) => {
  const list = await Object(_server_pm2__WEBPACK_IMPORTED_MODULE_1__[/* getList */ "c"])();
  const {
    user
  } = req;
  const apps = user.isAdmin ? list : list.filter(a => user.hasRight(a.name, _shared_user__WEBPACK_IMPORTED_MODULE_2__[/* UserAppRight */ "a"].VIEW));
  res.status(200).json({
    apps
  });
};

/* harmony default export */ __webpack_exports__["default"] = (Object(_server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* combine */ "c"])(Object(_server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* method */ "e"])('GET'), _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* database */ "d"], _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* session */ "g"], Object(_server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* authenticate */ "b"])({
  required: true
}), _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* pm2 */ "f"], list));
