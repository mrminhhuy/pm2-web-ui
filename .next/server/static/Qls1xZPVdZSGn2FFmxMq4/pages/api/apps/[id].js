...
module.exports = __webpack_require__("iIO4");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getApp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return getLogs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return stopApp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return restartApp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return reloadApp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return deleteApp; });
/* harmony import */ var pm2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("pnm3");
/* harmony import */ var pm2__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(pm2__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _shared_pm2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("mBNB");
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("mw/K");
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var bluebird__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("LLGo");
...
const fs = bluebird__WEBPACK_IMPORTED_MODULE_3__["promisifyAll"](fs__WEBPACK_IMPORTED_MODULE_2___default.a);
const getList = () => new Promise((resolve, reject) => pm2__WEBPACK_IMPORTED_MODULE_0___default.a.list((err, list) => err ? reject(err) : resolve(list)));
const getApp = async name => {
  ...
  for (let i = 0; i < list.length; i++) {
    ...
    if (app.pm2_env.exec_mode !== _shared_pm2__WEBPACK_IMPORTED_MODULE_1__[/* ExecMode */ "b"].CLUSTER) {
      break;
    }
  }
...
const getDescription = pmId => new Promise((resolve, reject) => pm2__WEBPACK_IMPORTED_MODULE_0___default.a.describe(pmId, (err, list) => err ? reject(err) : resolve(list)));
...
const stopApp = name => new Promise((resolve, reject) => pm2__WEBPACK_IMPORTED_MODULE_0___default.a.stop(name, err => err ? reject(err) : resolve()));
const restartApp = name => new Promise((resolve, reject) => pm2__WEBPACK_IMPORTED_MODULE_0___default.a.restart(name, err => err ? reject(err) : resolve()));
const reloadApp = name => new Promise((resolve, reject) => pm2__WEBPACK_IMPORTED_MODULE_0___default.a.reload(name, err => err ? reject(err) : resolve()));
const deleteApp = name => new Promise((resolve, reject) => pm2__WEBPACK_IMPORTED_MODULE_0___default.a.delete(name, err => err ? reject(err) : resolve()));
...
/* harmony import */ var _server_middlewares__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("6Bc4");
/* harmony import */ var _server_pm2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("9eSz");
/* harmony import */ var _shared_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("nLWT");
/* harmony import */ var _shared_user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("v9gO");
...
const onGet = async (req, res) => {
  ...
  if (!user.isAdmin && !user.hasRight(id, _shared_user__WEBPACK_IMPORTED_MODULE_3__[/* UserAppRight */ "a"].VIEW)) {
    throw new _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* RequestError */ "a"]('You do not have access to this application.', 403);
  }

  const app = await Object(_server_pm2__WEBPACK_IMPORTED_MODULE_1__[/* getApp */ "b"])(id);

  if (!app) {
    throw new _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* RequestError */ "a"]('This application does not exist.', 404);
  }
...
const actions = {
  [_shared_actions__WEBPACK_IMPORTED_MODULE_2__[/* AppAction */ "a"].DELETE]: {
    fn: _server_pm2__WEBPACK_IMPORTED_MODULE_1__[/* deleteApp */ "a"],
    right: _shared_user__WEBPACK_IMPORTED_MODULE_3__[/* UserAppRight */ "a"].DELETE
  },
  [_shared_actions__WEBPACK_IMPORTED_MODULE_2__[/* AppAction */ "a"].STOP]: {
    fn: _server_pm2__WEBPACK_IMPORTED_MODULE_1__[/* stopApp */ "g"],
    right: _shared_user__WEBPACK_IMPORTED_MODULE_3__[/* UserAppRight */ "a"].MANAGE
  },
  [_shared_actions__WEBPACK_IMPORTED_MODULE_2__[/* AppAction */ "a"].RELOAD]: {
    fn: _server_pm2__WEBPACK_IMPORTED_MODULE_1__[/* reloadApp */ "e"],
    right: _shared_user__WEBPACK_IMPORTED_MODULE_3__[/* UserAppRight */ "a"].MANAGE
  },
  [_shared_actions__WEBPACK_IMPORTED_MODULE_2__[/* AppAction */ "a"].RESTART]: {
    fn: _server_pm2__WEBPACK_IMPORTED_MODULE_1__[/* restartApp */ "f"],
    right: _shared_user__WEBPACK_IMPORTED_MODULE_3__[/* UserAppRight */ "a"].MANAGE
  },
  [_shared_actions__WEBPACK_IMPORTED_MODULE_2__[/* AppAction */ "a"].START]: {
    fn: _server_pm2__WEBPACK_IMPORTED_MODULE_1__[/* restartApp */ "f"],
    right: _shared_user__WEBPACK_IMPORTED_MODULE_3__[/* UserAppRight */ "a"].MANAGE
  }
};
...
const onPost = async (req, res) => {
  ...
  if (!user.isAdmin && !user.hasRight(id, right)) {
    throw new _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* RequestError */ "a"]('You don\'t have enough permissions to do this.', 403);
  }
  ...
  try {
    ...
    throw new _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* RequestError */ "a"]((_err$message = err.message) !== null && _err$message !== void 0 ? _err$message : err.toString());
  }
};

const onRequest = (req, res) => req.method === 'GET' ? onGet(req, res) : onPost(req, res);

/* harmony default export */ __webpack_exports__["default"] = (Object(_server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* combine */ "c"])(Object(_server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* method */ "e"])('GET', 'POST'), _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* database */ "d"], _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* session */ "g"], Object(_server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* authenticate */ "b"])({
  required: true
}), _server_middlewares__WEBPACK_IMPORTED_MODULE_0__[/* pm2 */ "f"], onRequest));
